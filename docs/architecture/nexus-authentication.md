...
```
┌─────────────────────────────────────────────────────────────────┐
│  Nexus Integrations destination (Nexus-only)                     │
...
method in the Nexus Integrations destination; switching methods clears the other
method's credentials (clean transition, no stale leftovers). Sign-out resets
to `None`.

The API-key block in the Nexus Integrations destination is gated behind the
...
use the other). The user's explicit choice in the Nexus Integrations destination is the
...
## Nexus Integrations destination

A **hosted Nexus Integrations destination** in the shell's navigation rail
