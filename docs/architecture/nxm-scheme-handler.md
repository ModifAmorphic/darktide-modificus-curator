...
user action from the Nexus Integrations destination (a "Nexus download links" section with
...
Nexus Integrations destination. No polling: the OS registration rarely changes
out-of-band.
